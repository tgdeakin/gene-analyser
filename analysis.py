...
def run_analysis(genes_of_interest):
    ...
    for k, v in gene_dict.items():
        ...
        print("There should be " + str(len(unique_interactions)) + " interaction(s) , but you have " + str(len(unique_interactions) - len(mirna_coords_to_display.strip().split(" "))) + " missing interaction(s)")

        print(k, '[', coords_to_display, ']', ':', str(len(mirna_coords_to_display.strip().split(" "))) + " interactions", "-", mirna_coords_to_display.strip().split(" "))
